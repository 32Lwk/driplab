...
const GIFT_OR_BUNDLE =
  /ギフトセット|×\d+個(?:セット)?|\d+個(?:セット)?|\d+袋(?:セット)?|2種.*セット|3種.*セット|コーヒーセレクション|詰め合わせ|アソート|お試しセット|【まとめ買い】|選べる\s*まとめ買い|まとめ買い/i;

/** Multi-pack / bulk-purchase SKUs only — single-bag 【大容量】 (e.g. 400g) is kept. */
const BULK_VARIANT =
  /【まとめ買い】|選べる\s*まとめ買い|（まとめ買い対象）|\d+g\s*\d+袋|\d+袋\s*（まとめ買い/;

...
調査日: 2026-08-08  
**再検証:** 2026-08-08（`category_id=7` ライブ照合・店舗 PDF 再確認）  
調査者: DripLab プロジェクト  
結論: **MVP に十分な豆データあり（オンラインショップで 12 品目）。スクレイピング実施可能。**

### 再調査結論（2026-08-08）

**カタログ 14 品目 = EC 12 + 店舗限定 2。**

```
Live EC IDs: 19, 20, 21, 22, 26, 27, 29, 30, 32, 236, 243, 244
Store-only:  store-2107 (イタリアンエスプレッソ), store-209705 (アイスコーヒー)
```
...
店舗 PDF（[2026priceDCS.pdf](https://www.doutor.co.jp/news/2026priceDCS.pdf)）には EC にない豆がある。**DripLab は購入 URL 必須**のため EC 12 品目を正とするが、店舗拡張候補として以下を記録:

| 商品 | 容量 | 店舗価格(税込) | EC | 備考 |
|------|------|---------------|-----|------|
| イタリアンエスプレッソ | 200g | ¥1,210 | ❌ | [店舗商品ページ](https://www.doutor.co.jp/dcs/products/detail/2107.html) |
| アイスコーヒー（豆） | 200g | ¥1,240 | ❌ | 店舗 PDF のみ |
| マイルド等ブレンド | 200g | ¥1,110〜 | ❌ | EC は 500g のみ |

店舗全 14 豆 = EC 12 + イタリアンエスプレッソ + アイスコーヒー。
